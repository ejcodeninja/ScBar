(function(){
	...
	var defaultConfig = {
		...
		//Number - Max Width per Bar
		barMaxWidth: 100,
		
		//Number - Alignment from left
		barSetAlign: 0,
			...
			this.ScaleClass = Chart.Scale.extend({
                ...
                calculateBarX: function (datasetCount, datasetIndex, barIndex) {
                    var xWidth = this.calculateBaseWidth(),
                        xAbsolute = this.calculateX(barIndex) - (xWidth / 2) - options.barSetAlign,
		...
		getBarsAtEvent : function(e){
			var barsArray = [],
				...
				datasetIterator = function(dataset){
					if (typeof dataset.bars[barIndex] != 'undefined') {
			...
			for (var datasetIndex = 0; datasetIndex < this.datasets.length; datasetIndex++) {
				for (barIndex = 0; barIndex < this.datasets[datasetIndex].bars.length; barIndex++) {
					if (this.datasets[datasetIndex].bars[barIndex].inRange(eventPosition.x,eventPosition.y)){
						helpers.each(this.datasets, datasetIterator.bind(this));
						return barsArray;
					}
				}
			}
